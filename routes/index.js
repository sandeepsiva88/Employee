...
router.get('/home', function(req,res){
	if(req.session && req.session.user){
      ...
      if(req.session.user.role=="Faculty"){
	      qualification.find({"User":req.session.user.username}, function(err,docs){
	      certification.find({"user":req.session.user.username}, function(err,docs1){
	      publication.find({"user":req.session.user.username},function(err,docs2){
	      workshop.find({"user":req.session.user.username},function(err,docs3){
	      done.find({"user":req.session.user.username},function(err,docs4){
	      guided.find({"user":req.session.user.username},function(err,docs5){
	      personal.find({"Userid":req.session.user.username},function(err,docs6){
          otherachievements.find({"user":req.session.user.username},function(err,docs7){
	      ...
	      res.render('index');
	    	...
	    	certification.find({"department":req.session.user.department}, function(err,docs1){
				...
				personal.find({"department":req.session.user.department},function(err,docs6){
